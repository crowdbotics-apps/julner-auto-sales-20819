"""julner_auto_sales_20819 URL Configuration
...
admin.site.site_header = "Julner Auto Sales"
admin.site.site_title = "Julner Auto Sales Admin Portal"
admin.site.index_title = "Julner Auto Sales Admin"

# swagger
api_info = openapi.Info(
    title="Julner Auto Sales API",
    default_version="v1",
    description="API documentation for Julner Auto Sales App",
)
